...
export default class Layout extends React.Component {
	...
	render () {
        ...
        return (
    <div id='front-page'>
       <h2>Realtime Leaderboard (V0.0.7 Alpha)</h2>
