...
export default class Layout extends React.Component {
	...
	render () {
        ...
        return (
    <div id='front-page'>
       <h2>Realtime Leaderboard (V0.0.5 Alpha)</h2>
       ...
       <p>Scores are entered from the 'Scorecard' page. Progress of other competitors in the same competition at the same course are  displayed in the leaderboard as they enter their own scores.</p> <p>This version provides for course selection</p>
